...
if __name__ == '__main__':
    ...
    config = {
        'w_width':15, #5,
        'w_stride':15,#3, # 3, 5
        'input_features':225, # 25 26 49 64 81 100 
                             # 121 144 169 196 225 256
        'max_length':8, # 120 / w_width pour des images toutes de même taille 120 X 120
        'batch_size':512,
        'num_epochs':1000,
        'hidden_size':256,
        'num_heads':2,
    ...
    if TRAINING:
        ...
        for e in tqdm(range(config['num_epochs'])):
            ...
            ###################################################################
            # if e % (config['num_epochs'] // 10) == 0 or e > config['num_epochs']-2:
            if e > config['num_epochs']-2:
