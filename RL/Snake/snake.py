...
sprites = {
    'head': cv2.imread('RL/Snake/sprites/head.png', 0),
    'body': cv2.imread('RL/Snake/sprites/body.png', 0),
    'turn': cv2.imread('RL/Snake/sprites/turn.png', 0),
    'fruit': cv2.imread('RL/Snake/sprites/fruit.png', 0),
    'tail': cv2.imread('RL/Snake/sprites/tail.png', 0),
}
...
if __name__ == '__main__':
    ...
    env = Env(8)  # small 4x4 grid

    # Writes the image to a file instead of opening a window
    cv2.imwrite('RL/Snake/prints/test.png', cv2.resize(env.to_image(), (640, 640), interpolation=cv2.INTER_NEAREST))
